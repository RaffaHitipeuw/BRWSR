...
export function NavigationBar({
  ...
  return (
    <div className="flex items-center h-12 px-2 bg-gray-50 border-b border-gray-200 gap-1" style={{ zIndex: 9999 }}>
      ...
      <div className="relative" ref={menuRef}>
        ...
        {showMenu && (
          <div
            className="absolute left-0 top-full mt-1 w-72 bg-white rounded-lg shadow-xl border border-gray-200"
            style={{ zIndex: 99999 }}
          >
            {/* Bookmark Toggle */}
            <button
              ...
              className={clsx(
                ...
                urlIsBookmarked ? "text-red-500" : "text-blue-600",
              )}
            >
              <svg className="w-5 h-5" fill={urlIsBookmarked ? "currentColor" : "none"} stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="p-2">
              ...
              <button
                onClick={() => { onNavigate(activeTab?.id, "https://www.google.com"); setShowMenu(false); }}
              ...
              <button
                onClick={() => { onNavigate(activeTab?.id, "https://youtube.com"); setShowMenu(false); }}
                className="w-full flex items-center gap-3 px-3 py-2 hover:bg-gray-50 rounded-lg transition-colors"
              >
              ...
              <button
                onClick={() => { onNavigate(activeTab?.id, "https://github.com"); setShowMenu(false); }}
                className="w-full flex items-center gap-3 px-3 py-2 hover:bg-gray-50 rounded-lg transition-colors"
              >
